    ...
    <div className="min-h-screen flex overflow-hidden bg-[#f0f4f8]">
      ...
      >
        ...
        >
          ...
          <p className="text-sm mt-2 tracking-widest uppercase" style={{ color: jenjang.accent }}>{jenjang.sub}</p>
      ...
      >
        <div className="w-full max-w-md">
          <div className="lg:hidden flex justify-center mb-8">
            <img src={jenjang.logo} alt="Logo" className="w-20 h-20 object-contain" />
          </div>
