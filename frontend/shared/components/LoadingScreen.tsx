...
export default function LoadingScreen({ show, title = 'Dashboard' }: { show: boolean; title?: string }) {
  return (
    <AnimatePresence>
      {show && (
        <motion.div
        ...
        >
          ...
          >
            ...
            <p className="text-[#1B8B87] text-sm mt-1 tracking-widest uppercase">{title}</p>
          </motion.div>
