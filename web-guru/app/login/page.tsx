  ...
  return (
    <div className="min-h-screen flex overflow-hidden bg-[#f0f4f8]">
      ...
      >
        ...
        >
          <h2 className="text-white text-2xl font-bold tracking-wide drop-shadow-lg">Al Fakhir School</h2>
          <p className="text-white text-sm mt-2 tracking-widest uppercase drop-shadow">Portal Guru</p>
